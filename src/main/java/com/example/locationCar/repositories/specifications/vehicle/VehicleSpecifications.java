...
public class VehicleSpecifications {
    ...
    public Specification<VehicleModel> buildSpec(String cor, Double avaliacaoMedia, Double precoMaximo, Double precoMinimo){
        Specification<VehicleModel> spec = Specification
                .where(VehicleSpecifications.colorEquals(cor))
