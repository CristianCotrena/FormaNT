...
public class CreateRentService {
    ...
    public CreateRentService(ClientRepository clientRepository, EmployeeRepository employeeRepository, VehicleRepository vehicleRepository, RentRepository rentRepository) {
    ...
    public BaseDto inserir(RentInputDto dto) {
        ...
        try{
            Optional<RentModel> rentExists = rentRepository.findByVehicleAndContractingDateLessThanEqualAndReturnDateGreaterThanEqual(vehicle.get(), dto.getReturnDate(),dto.getContractingDate());
        ...
        return new ResponseSuccessBuilder<CreateRentDto>(HttpStatus.CREATED, new CreateRentDto(createdId.toString()), SuccessMessage.CREATE_RENT).get();
    }
}
