...
public class ListVehicleParamTest {
    ...
    public void setup() {
        ...
        dto = new VehicleInputDto("BRA2E25","Tesla","s",4,"Black","eletric", BigDecimal.valueOf(50.3), BigDecimal.valueOf(300.5),BigDecimal.valueOf(4.5));
        dto2 = new VehicleInputDto("BRA2E22","Tesla","X",4,"Blue","eletric", BigDecimal.valueOf(30.3), BigDecimal.valueOf(5550.5),BigDecimal.valueOf(3.3));
        dto2 = new VehicleInputDto("BRA2E12","Ford","Fiesta",2,"Blue","gasoline", BigDecimal.valueOf(90.3), BigDecimal.valueOf(50.5),BigDecimal.valueOf(4.8));
    }
