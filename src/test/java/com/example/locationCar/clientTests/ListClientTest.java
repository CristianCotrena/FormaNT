...
public class ListClientTest {
    ...
    public void setup() {
        ...
        clients.add(new ClientModel(UUID.fromString("771079a3-7d31-433c-aae8-24a14b2b8c46"), "Cliente 1", "435.763.342-21", "874658935467", 12, "11999999999", "11999999999", "cliente1@gmail.com", 1));
        clients.add(new ClientModel(UUID.fromString("771079a3-7d31-433c-aae8-24a14b2b8c47"), "Cliente 2", "435.763.342-22", "874658935467", 25, "11999999999", "11999999999", "cliente2@gmail.com", 1));
        clients.add(new ClientModel(UUID.fromString("771079a3-7d31-433c-aae8-24a14b2b8c48"), "Cliente 3", "435.763.342-23", "874658935467", 18, "11999999999", "11999999999", "cliente3@gmail.com", 1));
        clients.add(new ClientModel(UUID.fromString("771079a3-7d31-433c-aae8-24a14b2b8c49"), "Cliente 4", "435.763.342-24", "874658935467", 32, "11999999999", "11999999999", "cliente4@gmail.com", 1));
    }
    ...
    public void testListClients_AgeFilter() {
        ...
        for (ClientModel client : clients) {
            if (client.getAge() >= ageFilter) {
                filteredClients.add(client);
            }
        }

        when(listClientService.listClients(ageFilter, null)).thenReturn(new PageImpl<>(filteredClients));

        ResponseEntity<Object> responseEntity = clientController.listClients(ageFilter, null);
    ...
    public void testListEmployees_NotFound() {
        when(listClientService.listClients(null, null)).thenReturn(Page.empty());
