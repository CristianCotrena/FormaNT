...
public class UpdateAddressTest {
  ...
  @Mock private UpdateAddressService updateAddressService;
  ...
  public void setup() {
    ...
    addressUpdateDto =
        new AddressUpdateDto(
            null, "Sim", "Bage", 457, "Loja", "Cachoeirinha", "RS", "Brasil", "94945-000");
  }
  ...
  public void testUpdateAddress_Success() {
    ...
    when(updateAddressService.updateAddress(addressId, addressUpdateDto))
        .thenReturn(
            new ResponseSuccessBuilder<AddressUpdateDto>(
                    HttpStatus.OK,
                    new AddressUpdateDto(addressId.toString()),
                    SuccessMessage.UPDATE_ADDRESS)
                .get());

    BaseDto<Void> updateAddress =
  ...
  public void testUpdateAddress_InvalidFields() {
    ...
    BaseDto<Void> baseDto = addressController.updateAddress(addressId.toString(), addressUpdateDto);
